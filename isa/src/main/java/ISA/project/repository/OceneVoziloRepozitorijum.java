...
public interface OceneVoziloRepozitorijum extends JpaRepository<OceneVozilo, Long> {
	...
	@Query("select ocene from OceneVozilo ocene where ocene.idKorisnika = :idKor and ocene.idVozila = :idVoz")
	OceneVozilo vratiOcenu(@Param("idKor") long idKor, @Param("idVoz") long idLet);
}
